...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nubrick",
            url: "https://github.com/plaidev/nubrick-ios/releases/download/v0.14.2/Nubrick.xcframework.zip",
            checksum: "f38c4b8daba4aea1ab9ac2aa0eba1bcad2564b3751fcb48dbc7a2335fe22003c"
        ),
