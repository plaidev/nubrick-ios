...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nubrick",
            url: "https://github.com/plaidev/nubrick-ios/releases/download/v0.15.0/Nubrick.xcframework.zip",
            checksum: "72015102a48fa88256f6aec27acc9a0bad273c3d47ae1d2400584c4a347fc98f"
        ),
