...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nubrick",
            url: "https://github.com/plaidev/nubrick-ios/releases/download/v0.18.3/Nubrick.xcframework.zip",
            checksum: "4acb7cd60b8e5266cad97281b5883c8e12c794d83e7d36c59fb9b70d9805b1ee"
        ),
